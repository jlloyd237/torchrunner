...
from torchrunner.optimizer import LAMB
...
def main():
    ...
    # specify optimizer
    optimizer = LAMB([{'params': model[0:3].parameters()}, {'params': model[3:8].parameters()}])
    ...
    run.train(n_epochs=3, lr=(1e-3, 1e-2), device='cuda')
