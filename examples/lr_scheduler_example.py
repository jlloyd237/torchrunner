...
from torchrunner.scheduler import OptimLRScheduler
...
def main():
    ...
    run = Runner(model, train_dl=train_dl, val_dl=val_dl, loss_fn=loss_fn,
                 ...
                 OptimLRScheduler(OneCycleLR, max_lr=max_lr, total_steps=total_steps,
                                  pct_start=0.3, div_factor=1e1, final_div_factor=1e4)])
